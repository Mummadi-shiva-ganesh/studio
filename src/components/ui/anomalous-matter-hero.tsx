  ...
  useEffect(() => {
    ...
    const material = new THREE.ShaderMaterial({
      uniforms: {
        ...
        color: { value: new THREE.Color("hsl(142, 71%, 45%)") },
      },
    ...
    (lightRef as React.MutableRefObject<THREE.PointLight>).current = pointLight;
    ...
    >
      ...
      <div className="relative z-20 flex flex-col items-center justify-end h-full pb-20 md:pb-32 text-center">
        <div className="max-w-3xl px-4 animate-fade-in-long">
          ...
          <p className="font-headline mt-4 text-4xl md:text-6xl font-bold leading-tight">
            {subtitle}
          </p>
          <p className="mt-6 max-w-xl mx-auto text-base leading-relaxed text-muted-foreground/80">
            {description}
          </p>
        </div>
      </div>
